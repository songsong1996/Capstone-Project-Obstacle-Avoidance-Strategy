...
def dataloader(filepath):
  ...
  #left_val = [filepath+left_fold+img for img in test]
  #right_val = [filepath+right_fold+img for img in test]
  #disp_val_L = [filepath+disp_L+img for img in test]
  ...
  left_fold_train  = 'training/image_2/'
  right_fold_train = 'training/image_3/'
  disp_L_train = 'training/disp_occ_0/'
  
  left_fold_test = 'testing/image_2/'
  right_fold_test = 'testing/image_3/'
  disp_L_test = 'testing/disp_occ_0/'
  ...
  disp_train_L = [filepath+disp_L_train+img for img in train] + [filepath+disp_L_test+img for img in train]
  ...
  disp_val_L = [filepath+disp_L_train+img for img in val]

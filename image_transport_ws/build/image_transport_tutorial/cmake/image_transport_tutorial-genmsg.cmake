...
set(MSG_I_FLAGS "-Iimage_transport_tutorial:/home/songsong/image_transport_ws/src/image_transport_tutorial/msg;-Isensor_msgs:/opt/ros/kinetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/songsong/image_transport_ws/src/image_transport_tutorial/msg/ResizedImage.msg" NAME_WE)
add_custom_target(_image_transport_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "image_transport_tutorial" "/home/songsong/image_transport_ws/src/image_transport_tutorial/msg/ResizedImage.msg" "std_msgs/Header:sensor_msgs/Image"
)
...
_generate_msg_cpp(image_transport_tutorial
  "/home/songsong/image_transport_ws/src/image_transport_tutorial/msg/ResizedImage.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/image_transport_tutorial)
  install(CODE "execute_process(COMMAND \"/home/songsong/Documents/Softwares/anaconda3/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/image_transport_tutorial\")")
  # install generated code
  install(

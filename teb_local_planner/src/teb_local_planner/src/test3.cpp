...
{
  outfile.open("/home/songsong/catkin_workspace/teb_local_planner/src/teb_local_planner/src/zz.txt",ios::out | ios::app);
...
void CB_mainCycle(const ros::TimerEvent &e)
{
  ...
  if (robot_plan_message.size() != 0)
  {
    ...
    outfile<< std::to_string(robot_position_plan.x)+" "+std::to_string(robot_position_plan.y) <<endl;

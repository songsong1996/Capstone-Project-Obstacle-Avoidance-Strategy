...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/songsong/catkin_workspace/turtlebot_gazebo/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/songsong/catkin_workspace/turtlebot_gazebo/install/lib;/home/songsong/gazebo8_ros/devel/lib;/home/songsong/pibot_ros/ros_ws/devel/lib;/home/songsong/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
